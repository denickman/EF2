...
class RemoteLoaderTests: XCTestCase {
        ...
        private func makeSut(
            ...
            line: UInt = #line
        ) -> (client: HTTPClientSpy, sut: RemoteLoader) {
            let client = HTTPClientSpy()
        ...
        private func expect(
            _ sut: RemoteLoader,
            toCompleteWithResult expected: RemoteLoader.Result,
            when action: () -> Void,
            file: StaticString = #filePath,
            line: UInt = #line
        ) {
            ...
            sut.load { received in
                ...
                case (.failure(let receivedError as RemoteLoader.Error), .failure(let expectedError as RemoteLoader.Error)):
