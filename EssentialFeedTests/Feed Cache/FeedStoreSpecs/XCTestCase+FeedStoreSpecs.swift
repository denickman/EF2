...
// where Self: XCTestCase - we constrain the protocol extension to XCTestCase subclasses since the
// helpers use XCTestCase methods. Also, it serves as documentation, denoting this protocol extension is for
// tests only

extension FeedStoreSpecs where Self: XCTestCase {
    
    
    func assertThatRetrieveDeliversEmtpyOnEmptyCache(on sut: FeedStore, file: StaticString = #filePath, line: UInt = #line) {
        expect(sut, toRetrieve: .empty, file: file, line: line)
    }
